...
const { address, fullDate, localName, supportAppPhone } = EVENT_CONFIG;
...
export const qna = [
  ...
  },
  {
    ...
    answer: `Entre em contato conosco através do whatsapp ${supportAppPhone} informando o seu nome completo que recuperamos o código pra você!`,
  },
  {
    id: 'q_3',
  ...
  },
  {
    ...
    answer: `Entre em contato conosco através do whatsapp ${supportAppPhone} informando o seu código que fazemos a confirmação/cancelamento manualmente na aplicação.`,
  },
  {
    id: 'q_5',
